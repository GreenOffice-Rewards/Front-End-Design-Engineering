          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="space-y-2 text-gray-600 dark:text-gray-300 mb-4">
                <p><strong>RM:</strong> {member.rm}</p>
                <p><strong>Turma:</strong> {member.turma}</p>
              </div>
              ...
              <div className="flex justify-center space-x-4">
                <a 
                  ...
                  className="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-all transform hover:scale-125"
                >
